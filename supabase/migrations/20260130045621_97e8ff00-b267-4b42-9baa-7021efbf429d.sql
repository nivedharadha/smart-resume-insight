...
-- Add delete policy for analysis_records (admins only)
...
-- Insert admin role for the specified email (will need user_id after signup)
-- We'll handle this via edge function after user signs up